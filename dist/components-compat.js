...
/***/function (module, exports, __webpack_require__) {
    ...
    // module
    exports.push([module.i, "/*!\n *  @license\n *    Copyright 2017 Brigham Young University\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */\n/*!\n *  @license\n *    Copyright 2017 Brigham Young University\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */:host .root{width:33%;margin:10px;display:flex;flex-direction:column;box-sizing:border-box}:host .title-slotted-content{width:100%;padding:5px;align-items:center;box-sizing:inherit;flex:1;flex-basis:100%}:host .title-container{width:80%;float:left}:host .logo-container{float:right;width:20%}:host .logo-container img{height:15px}:host .first-row{box-sizing:inherit;padding:5px}:host .left-slot-container{float:left;width:30%}:host .right-slot-container{float:right;width:70%}:host .center-slot-container{width:100%;padding:5px;align-items:flex-end}:host([withoout-logo]) .root{width:33%;margin:10px;display:flex;flex-direction:column;box-sizing:border-box}:host([withoout-logo]) .title-slotted-content{width:100%;padding:5px;align-items:center;box-sizing:inherit;flex:1;flex-basis:100%}:host([withoout-logo]) .title-container{width:80%;float:left}:host([withoout-logo]) .logo-container{float:right;width:20%}:host([withoout-logo]) .logo-container img{height:15px}:host([withoout-logo]) .first-row{box-sizing:inherit;padding:5px}:host([withoout-logo]) .left-slot-container{float:left;width:30%}:host([withoout-logo]) .right-slot-container{float:right;width:70%}:host([withoout-logo]) .center-slot-container{width:100%;padding:5px;align-items:flex-end}:host([withoout-logo]) .logo-container{display:none}.title-slotted-content{background-color:var(--byu-feature-card-title-background,#002e5d);color:var(--byu-feature-card-title-color,#fff)}", ""]);
